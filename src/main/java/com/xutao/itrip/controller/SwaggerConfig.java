...
// @EnableWebMvc
@EnableSwagger2
@ComponentScan(basePackages = { "com.xutao.itrip.controller" })
@Configuration
public class SwaggerConfig extends WebMvcConfigurationSupport {
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("爱旅行-认证模块API").termsOfServiceUrl("http://localhost:8090/biz")
				.contact("t220@czkt.com").version("1.0").build();
	}
}